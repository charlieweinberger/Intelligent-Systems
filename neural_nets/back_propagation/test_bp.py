...
plt.legend()
plt.savefig('neural_nets/back_propagation/bp_data_vs_initial_regressor_vs_final_regressor.png')

plt.figure(1)
plt.plot(num_iterations, rss)
plt.xlabel('num iterations')
plt.ylabel('rss')
plt.savefig('neural_nets/back_propagation/bp_num_iterations_vs_rss.png')