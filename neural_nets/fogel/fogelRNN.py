...
class FogelRandomNeuralNet():

    def __init__(self, node_layers, bias_node_indices, f, weight_range, mutation_rate, weights=""):
        ...
        self.weights = self.random_weights(node_layers, weight_range) if weights == "" else weights
    ...
    def make_a_copy(self, weights=""):
        return FogelRandomNeuralNet(self.node_layers, self.bias_node_indices, self.f, self.weight_range, self.mutation_rate, weights)
